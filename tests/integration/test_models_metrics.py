...
class TestTestRequirementModel:
    ...
    def test_test_requirement_to_dict(self):
        ...
        from src.models.impact import PyramidLevel, ScenarioType, TestRequirement

        req = TestRequirement(
            id="TEST-001",
            impact_id="IMP-001",
            test_type=PyramidLevel.UNIT,
    ...
    def test_test_requirement_to_dict_optional_fields(self):
        ...
        req = TestRequirement(
            id="TEST-002",
            impact_id="IMP-001",
            test_type=PyramidLevel.CONTROLLER,
...
@pytest.mark.integration
class TestPyramidLevelEnum:
    """Tests for PyramidLevel enum."""

    def test_all_test_types(self):
        """Should have expected test types."""
        from src.models.impact import PyramidLevel

        test_types = [t.value for t in PyramidLevel]
