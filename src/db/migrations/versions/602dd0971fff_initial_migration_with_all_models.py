...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('ACTIVE', 'ARCHIVED', 'ANALYZING', 'UPDATING', 'ERROR', name='projectstatus'), nullable=False),
    ...
    sa.Column('scope', sa.Enum('COMPILE', 'PROVIDED', 'RUNTIME', 'TEST', 'SYSTEM', 'IMPORT', name='dependencyscope'), nullable=False),
    sa.Column('update_status', sa.Enum('CURRENT', 'UPDATE_AVAILABLE', 'VULNERABLE', 'UNKNOWN', name='updatestatus'), nullable=False),
    ...
    op.create_index(op.f('ix_dependencies_artifact_id'), 'dependencies', ['artifact_id'], unique=False)
    ...
    sa.Column('modification_type', sa.Enum('DEPENDENCY_UPDATE', 'DEPENDENCY_ADD', 'DEPENDENCY_REMOVE', 'PROPERTY_CHANGE', 'PLUGIN_UPDATE', 'CONFIG_CHANGE', name='modificationtype'), nullable=False),
    sa.Column('status', sa.Enum('PENDING', 'APPLIED', 'VALIDATED', 'ROLLED_BACK', 'FAILED', name='modificationstatus'), nullable=False),
    ...
    op.create_index('ix_project_locks_project_path', 'project_locks', ['project_path'], unique=False)
